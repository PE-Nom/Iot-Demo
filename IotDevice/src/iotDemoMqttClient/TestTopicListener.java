...
public class TestTopicListener extends AWSIotTopic {
	...
	static Logger logger = Logger.getLogger(TestTopicListener.class.getName());
    ...
    public void onMessage(AWSIotMessage message) {
        TestTopicListener.logger.info("TestTopicListener " + System.currentTimeMillis() + ": <<< " + message.getStringPayload());
    }
